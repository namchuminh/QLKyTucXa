            ...
            <form method="post">
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ten" placeholder="Mã sinh viên" name="masinhvien" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="ten">Số CCCD</label>
                    <input type="number" class="form-control" id="ten" placeholder="Số căn cước công dân" name="socccd" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="ten">Tên Sinh Viên</label>
                    <input type="text" class="form-control" id="ten" placeholder="Tên sinh viên" name="tensinhvien" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="ten">Ngày Sinh</label>
                    <input type="date" class="form-control" id="ten" placeholder="Ngày sinh" name="ngaysinh" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="ten" placeholder="Số điện thoại" name="sodienthoai" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="ten">Khoa / Ngành Học</label>
                    <input type="text" class="form-control" id="ten" placeholder="Chuyên ngành học" name="khoa" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
