              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ten" placeholder="Mã nhân viên" name="manhanvien" required>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="ten">Tên Nhân Viên</label>
                    <input type="text" class="form-control" id="ten" placeholder="Tên nhân viên" name="tennhanvien" required>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="ten">Địa Chỉ</label>
                    <input type="text" class="form-control" id="ten" placeholder="Địa chỉ" name="diachi" required>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
